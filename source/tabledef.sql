...
CREATE OR Replace TABLE FILELIB/TABLE_FIELD_DEFINITION FOR SYSTEM NAME TABLEDEF ( 
    TABLE_NAME for column tabname char(10) not null,
	TEXT VARCHAR(50) CCSID 37 NOT NULL , 
	FIELD_NAME for column FLD VARCHAR(10) CCSID 37 NOT NULL , 
	DATA_TYPE VARCHAR(9) CCSID 37 NOT NULL , 
	...
	Column_TEXT for column ctext char(50) CCSID 37 not null,
